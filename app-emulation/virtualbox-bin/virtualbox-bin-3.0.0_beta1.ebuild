...
SRC_URI="amd64? ( http://download.virtualbox.org/virtualbox/${MY_PV0}/${MY_P}_amd64.run )
	x86? ( http://download.virtualbox.org/virtualbox/${MY_PV0}/${MY_P}_x86.run )
	sdk? ( http://download.virtualbox.org/virtualbox/${MY_PV0}/VirtualBoxSDK-${MY_PV}.zip )"
