...
pkg_setup() {
	...
	echo
	ewarn "If you re-run this within 1 hour, it will skip the update"
	ewarn "To bypass this:"
	ewarn " touch -t 199901010101 /usr/portage/distfiles/svn-src/mythtv/mythtv/.svn/entries"
	echo
