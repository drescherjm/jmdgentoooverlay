...
inherit edo flag-o-matic java-pkg-opt-2 java-utils-2 python-any-r1
...
PATCHES=(
	"${FILESDIR}"/${PN}-34.0-libva.patch
#	"${FILESDIR}"/${PN}-34.0-ffmpeg-binutils-2.41.patch
#	"${FILESDIR}"/${PN}-34.0-linux-headers-6.5.patch
)
