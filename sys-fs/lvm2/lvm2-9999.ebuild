...
EGIT_REPO_URI="git://sourceware.org/git/lvm2.git"
...
src_prepare() {
	...
	#epatch "${FILESDIR}"/lvm2-2.02.84-pvid-create_instance.patch
	#epatch "${FILESDIR}"/lvm2-2.02.84-metadataareas_stored_in_format_instance.patch
	#epatch "${FILESDIR}"/lvm2-2.02.84-add_format_instance_fid_field_struct.patch
	#epatch "${FILESDIR}"/lvm2-2.02.84-add_format_instance_support_for_pv_read.patch
	#epatch "${FILESDIR}"/lvm2-2.02.84-add_attach_existing_mdas_parameter_to_create_instance_fn.patch
